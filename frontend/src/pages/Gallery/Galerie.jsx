...
const ALBUME = [
    {
        ...
        files: ["maerean.jpg", "2.jpg", "3.jpg", "4.jpg", "5.jpg", "6.jpg", "7.jpg", "8.jpg", "9.jpg"
    ...
    },
    {
        ...
        files: ["cover_2.jpg", "2.jpg", "3.jpg", "4.jpg", "5.jpg", "6.jpg", "7.jpg", "8.jpg", "9.jpg", "10.jpg"
        , "11.jpg", "12.jpg"],
    },
    {
        ...
        files: ["cover_3.jpg", "1.jpg", "2.jpg", "3.jpg", "4.jpg", "5.jpg", "6.jpg", "7.jpg", "8.jpg", "9.jpg"],
    },
];
...
const Galerie = () => {
    ...
    const albums = useMemo(() => {
        ...
        return ALBUME.filter(a =>
            a.title.toLowerCase().includes(term) || a.slug.toLowerCase().includes(term)
        );
    }, [filter]);
                ...
                {albums.length === 0 ? (
                    ...
                    <div className="albums-grid">
                        {albums.map((a) => {
                            ...
                            return (
                                <article className="album-card" key={a.id} onClick={() => openLightbox(a, 0)}>
                ...
                <div className="lightbox-backdrop" onClick={closeLightbox}>
                    <div className="lightbox" onClick={(e) => e.stopPropagation()}>
                        <header className="lightbox-head">
                            <h4>
                                {openAlbum.album.title} • {openAlbum.index + 1}/{openAlbum.album.files.length}
                            </h4>
                            <button className="btn-close" onClick={closeLightbox} aria-label="Închide">✕</button>
                        </header>
                        ...
                        <div className="lightbox-body">
                            ...
                            <img
                                ...
                                src={buildSrc(openAlbum.album.slug, openAlbum.album.files[openAlbum.index])}
                                alt=""
                                loading="eager"
                                onClick={goNext}
                            />
