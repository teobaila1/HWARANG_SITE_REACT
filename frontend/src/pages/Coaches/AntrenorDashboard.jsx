    ...
    <>
      ...
      <div className="dashboard">
        <div className="dashboard-header">
          <h2>Grupele tale și elevii acestora</h2>
        </div>
        ...
        {!loading && data.map((grupaData, idx) => (
          <div key={idx} className="grupa-card">
            <div className="grupa-head">
              ...
              <button className="btn btn-primary" onClick={() => handleAdd(grupaData)}>Adaugă elev</button>
            </div>
              ...
              {grupaData.copii.map((copil, i) => (
                <li key={copil.id || i} className="elev-item">
                  ...
                  <div className="elev-actions">
                    <button className="btn btn-sm" onClick={() => handleEdit(copil, grupaData)}>Editează</button>
