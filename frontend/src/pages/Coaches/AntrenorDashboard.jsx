              ...
              {grupaData.copii.map((copil) => (
                <li key={copil.id} className="elev-item">
                  <div className="elev-info">
                    <div><span className="elev-label">Nume:</span> <span className="elev-value">{copil.nume}</span></div>
                    <div><span className="elev-label">Gen:</span> <span className="elev-value">{prettyGen(copil.gen)}</span></div>
                    <div><span className="elev-label">Vârstă:</span> <span className="elev-value">{copil.varsta} ani</span></div>
                    <div>
                      <span className="elev-label">Părinte:</span>{" "}
                      <span className="elev-value">{parentName(copil._parent)}</span>
                    </div>
                    <div><span className="elev-label">Email părinte:</span> <span className="elev-value">{copil._parent?.email || "—"}</span></div>
                  </div>
                  <div className="elev-actions">
                    <button className="btn btn-sm" onClick={() => handleEdit(copil)}>Editează</button>
                    <button className="btn btn-sm btn-danger" onClick={() => handleDeleteAsk(copil)}>Șterge</button>
                  </div>
                </li>
              ))}
            </ul>
