    ...
    return (
        <footer className="footer" id="footer">
            ...
            <div className="footer-info">
                ...
                <p>Contact: <strong>0747 756 508</strong></p>

                <h4 className="red-title">Urmărește-ne</h4>
                <div className="social-icons">
                    <a href="https://www.facebook.com/TudorRazvanLifestyke" target="_blank" rel="noreferrer">
                        <img src="/images/apps/facebook_dark.jpg" alt="Facebook"/>
                    </a>
                    <a href="https://www.instagram.com/kickboxingsibiu/profilecard/?igsh=aXJ0bXo3eWo4N3E5 " target="_blank" rel="noreferrer">
                        <img src="/images/apps/insta_dark.jpg" alt="Instagram"/>
                    </a>
                    <a href="https://www.tiktok.com/@kickboxingsibiu" target="_blank" rel="noreferrer">
            ...
            <div className="frtkd-block">
                    <img src="/images/apps/kickboxrazvan.jpeg" alt="FRTKD" className="frtkd-logo"/>
                <p className="frtkd-name">Champions K1 Sibiu Team</p>
            </div>

            <p className="copyright">
                © {new Date().getFullYear()} CHAMPIONS K1 SIBIU - Toate drepturile rezervate.
            </p>
        </footer>
    );
};
