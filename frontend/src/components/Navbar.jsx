        ...
        >
          ...
          {isLoggedIn && (
            <li className={`dropdown ${openSection === "cal" ? "open" : ""}`}>
              <a
                ...
                data-keep="true"
                onClick={(e) => { e.preventDefault(); toggleSection("cal"); }}
              >
                Calendar
              </a>
          ...
          <li className={`dropdown ${openSection === "kick" ? "open" : ""}`}>
            <a
              ...
              data-keep="true"
              onClick={(e) => { e.preventDefault(); toggleSection("kick"); }}
            >
              Kickbox
            </a>
          ...
          {isLoggedIn ? (
            <li className="dropdown user-menu">
              <button className="user-chip" aria-haspopup="true" aria-expanded="false" data-keep="true">
